...
values= ['01-04-2023','01-07-2023 CS', '01-07-2023 EE', '01-08-2023 EE',
         '01-08-2023 EE', '01-09-2023 CS', '01-09-2023 EE','01-10-2023 CS', '01-10-2023 EE']
#x=files.pop()
#x1= files1.pop()
...
my_bg = customtkinter.CTkLabel(frame_2, image = bg_image,  text=' ')
my_bg.place(x = 0, y= 0 )
...
label_1 = ttk.Label(frame_2, text='Files', font = ('Times New Roman', 35), background = '#202124', foreground='white')
label_1.pack(pady=10, padx=10)
...
button3 = customtkinter.CTkButton(root, text="Check Student Data",  command=lambda: info())
button3.pack(pady=100, padx=40)
button3.place(rely=0.80, relx=0.45)
